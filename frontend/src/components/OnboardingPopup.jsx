...
function OnboardingPopup() {
  ...
  return (
    <div style={{
      ...
      textAlign: 'left', color: '#eaeaea',
      fontFamily: "'Segoe UI', 'Noto Sans KR', Arial, sans-serif",
      lineHeight: 1.6, border: '1px solid #333', boxSizing: 'border-box',
      animation: 'popup-fade-in 0.32s ease-out'
    }}>
      <div style={{ fontWeight: 700, fontSize: 19, marginBottom: 6, letterSpacing: '-1.2px', color: '#fff' }}>
        더 똑똑한 게임 추천을 원한다면?
      </div>
      <ul style={{ fontSize: 15, margin: '18px 0 14px 20px', padding: 0, listStyle: 'disc', color: '#e6e6e6' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
        <button onClick={handleClose} style={{
          flex: 1, background: '#222', border: '1px solid #333', borderRadius: 9,
          padding: '10px 12px', color: '#e6e6e6', fontWeight: 900, cursor: 'pointer', fontSize: 14
        }}
