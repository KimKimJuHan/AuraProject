...
const styles = {
  ...
  suggestionsList: { position: 'absolute', top: '100%', left: 0, right: 0, backgroundColor: 'var(--bg-color, #141414)', border: '1px solid var(--border-color, #333)', listStyle: 'none', padding: 0, margin: 0, zIndex: 1000, marginTop:'5px', maxHeight:'420px', overflowY:'auto' },
  suggestionItem: { padding: '10px 15px', cursor: 'pointer', color: 'var(--text-main, #fff)', borderBottom: '1px solid var(--border-color, #222)' },
  suggestionItemSelected: { padding: '10px 15px', cursor: 'pointer', color: 'var(--text-main, #fff)', backgroundColor: 'var(--card-bg, #333)', fontWeight: 'bold', borderBottom: '1px solid var(--border-color, #222)' },
  ...
  suggestionTitle: { color:'var(--text-main, #fff)', fontSize:'14px', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis' },
  suggestionSubtitle: { color:'var(--text-sub, #888)', fontSize:'12px', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis', marginTop:'2px' },
  historyRow: { display:'flex', justifyContent:'space-between', alignItems:'center', gap:'10px', color: 'var(--text-main, #fff)' },
  historyDelete: { color:'var(--text-sub, #999)', cursor:'pointer', fontSize:'14px', flexShrink:0 },
  highlightText: { fontWeight: '800', color: 'var(--text-main, #fff)' },
