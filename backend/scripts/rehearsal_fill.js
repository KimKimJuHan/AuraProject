...
// ══════════════════════════════════════════════════════════════════
const GENRE_RATIO = {
    'MOBA':         { ratio: [0.05, 0.15], chzzkShare: 0.65 },
    '온라인RPG':    { ratio: [0.15, 0.35], chzzkShare: 0.55 },
    '배틀로얄':     { ratio: [0.03, 0.08], chzzkShare: 0.60 },
    'FPS':          { ratio: [0.02, 0.08], chzzkShare: 0.65 },
    'PvP':          { ratio: [0.02, 0.07], chzzkShare: 0.60 },
    '경쟁':         { ratio: [0.02, 0.06], chzzkShare: 0.60 },
    '격투':         { ratio: [0.03, 0.08], chzzkShare: 0.55 },
    '공포':         { ratio: [0.05, 0.15], chzzkShare: 0.70 },
    '생존':         { ratio: [0.04, 0.12], chzzkShare: 0.60 },
    '협동':         { ratio: [0.04, 0.12], chzzkShare: 0.65 },
    '로컬협동':     { ratio: [0.05, 0.15], chzzkShare: 0.70 },
    '멀티플레이':   { ratio: [0.03, 0.08], chzzkShare: 0.60 },
    '소울라이크':   { ratio: [0.05, 0.12], chzzkShare: 0.60 },
    '메트로배니아': { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    '로그라이크':   { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    'RPG':          { ratio: [0.03, 0.08], chzzkShare: 0.55 },
    '액션':         { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    '어드벤처':     { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    '전략':         { ratio: [0.01, 0.04], chzzkShare: 0.50 },
    '턴제':         { ratio: [0.01, 0.03], chzzkShare: 0.50 },
    '시뮬레이션':   { ratio: [0.01, 0.04], chzzkShare: 0.50 },
    '자원관리':     { ratio: [0.01, 0.03], chzzkShare: 0.50 },
    '기지건설':     { ratio: [0.01, 0.03], chzzkShare: 0.50 },
    '힐링':         { ratio: [0.03, 0.08], chzzkShare: 0.60 },
    '캐주얼':       { ratio: [0.03, 0.08], chzzkShare: 0.55 },
    '퍼즐':         { ratio: [0.01, 0.04], chzzkShare: 0.55 },
    '플랫포머':     { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    '리듬':         { ratio: [0.04, 0.10], chzzkShare: 0.60 },
    '비주얼노벨':   { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    '카드게임':     { ratio: [0.02, 0.06], chzzkShare: 0.55 },
    'default':      { ratio: [0.02, 0.05], chzzkShare: 0.55 },
};
const TAG_PRIORITY = [
